                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="align-middle text-center">
                                                <a href="/hapus_akun/{{$users->id}}" class="btn btn-link btn-icon-only btDDDn-rounded btn-sm text-dark icon-move-right my-auto" ><img src="icon/trash.png" width="17px" height="17px" alt=""></a>
